...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://jm3j2th9v7.execute-api.us-east-1.amazonaws.com/learntest';
    ...
    apigClient.qnaGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        var qnaGetRequest = {
            ...
            path: pathComponent + uritemplate('/qna').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(qnaGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.qnaPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        return apiGatewayClient.makeRequest(qnaPostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.qnaOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var qnaOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/qna').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(qnaOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.uploadObjectGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['object'], ['body']);
        
        var uploadObjectGetRequest = {
            verb: 'get'.toUpperCase(),
        ...
        return apiGatewayClient.makeRequest(uploadObjectGetRequest, authType, additionalParams, config.apiKey);
    };
